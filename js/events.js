...
const homeOpenHotHitsHaryanviBtn = document.getElementById('home-open-hot-hits-haryanvi-btn');
const homeOpenHotHitsEnglishBtn = document.getElementById('home-open-hot-hits-english-btn');
const homeOpenHotHitsPunjabiBtn = document.getElementById('home-open-hot-hits-punjabi-btn');
const homeOpenHotHitsHindiBtn = document.getElementById('home-open-hot-hits-hindi-btn');
...
export function initializePlayerEvents(player, audioPlayer, scrobbler, ui, lyricsManager) {
    ...
    if (homeOpenHotHitsEnglishBtn) {
        homeOpenHotHitsEnglishBtn.addEventListener('click', () => {
            navigate('/album/hot-hits-english');
        });
    }

    if (homeOpenHotHitsPunjabiBtn) {
        homeOpenHotHitsPunjabiBtn.addEventListener('click', () => {
            navigate('/album/hot-hits-punjabi');
        });
    }

    if (homeOpenHotHitsHindiBtn) {
        homeOpenHotHitsHindiBtn.addEventListener('click', () => {
            navigate('/album/hot-hits-hindi');
        });
    }
